...
/**
 * Config model that is aware of all \Paynow\Paynow payment methods
...
class Config extends AbstractConfig
{
    ...
    /** @var \Paynow\Paynow\Model\Paynow this is a model which we will use. */
    const METHOD_CODE = 'paynow';
