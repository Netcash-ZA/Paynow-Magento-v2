 ...
 */
namespace Paynow\Paynow\Controller;

include_once( dirname( __FILE__ ) .'/../Model/paynow_common.inc' );

use Paynow\Paynow\Model\Paynow;
...
abstract class AbstractPaynow extends AppAction implements RedirectLoginInterface
{
     ...
     * @param \Magento\Framework\Session\Generic $paynowSession
    ...
    public function __construct(
        ...
        \Magento\Framework\Session\Generic $paynowSession,
    ...
    )
    {
        ...
        $this->paynowSession = $paynowSession;
    ...
    protected function _initCheckout()
    {
        ...
        {
            $this->_checkoutSession->setPaynowQuoteId( $this->_checkoutSession->getQuoteId() );
            $this->_checkoutSession->setPaynowSuccessQuoteId( $this->_checkoutSession->getLastSuccessQuoteId() );
            $this->_checkoutSession->setPaynowRealOrderId( $this->_checkoutSession->getLastRealOrderId() );
